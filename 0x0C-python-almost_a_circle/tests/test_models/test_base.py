...
class TestBaseCreate(unittest.TestCase):
    ...
    def test_create_extra_args_square(self):
        with self.assertRaises(TypeError):
            s = Square(10, 7, 2, 8)
...
class TestBaseLoadFromFile(unittest.TestCase):
    ...
    def test_load_from_file_rectangle(self):
        ...
        self.assertEqual(str(list_rectangles[0]), str(list_output[0]))
    ...
    def test_load_from_file_square(self):
        ...
        self.assertEqual(str(list_squares[0]), str(list_output[0]))
...
class TestBaseSaveToFileCsv(unittest.TestCase):
    ...
    def test_save_to_file_csv_two_rectangles(self):
        ...
        with open("Rectangle.csv", "r") as f:
            self.assertTrue(len(f.read()) == 65)

    def test_save_to_file_csv_one_square(self):
        s = Square(10, 7, 2, 8)
        Square.save_to_file_csv([s])
        with open("Square.csv", "r") as f:
            self.assertTrue(len(f.read()) == 29)
